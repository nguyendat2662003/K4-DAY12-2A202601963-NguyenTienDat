...
class ChatStore:
    ...
    def ping(self) -> bool:
        ...
        try:
            ...
            # Mất mạng, sai mật khẩu, Redis chưa lên... — mọi lý do đều là
            # "chưa sẵn sàng", và /readyz cần một câu trả lời chứ không cần
            # một exception.
            return False
    ...
    def add_turn(self, client_id: str, role: str, content: str) -> None:
        ...
        # Giữ lại HISTORY_MAX_MESSAGES message MỚI NHẤT — prompt phình vô hạn
        # thì tiền token cũng vậy.
